...
To broadcast hologram, Processing 2.2.1, OBS Studio and your own YouTube account are also necessary.<br>
...
2) Install Simple OpenNI Version 1.96(https://code.google.com/archive/p/simple-openni/)<br>
